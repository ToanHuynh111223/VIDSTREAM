            ...
            <div className={clsx(styles.signupcard)}>
                ...
                <form className={clsx(styles.form)} action="#">
                    <div className={clsx(styles.formgroup)}>
                        ...
                        <input ref={userName} type="text" placeholder='Enter email' autoComplete="full-name"
                ...
                <div className={clsx(styles.info)}>
                    ...
                    <ThemeProvider theme={theme}>
                        <Button variant="contained" size="large" color={loginColor} onClick={onClickRegister}> Register</Button>
                    </ThemeProvider>
                </div>
